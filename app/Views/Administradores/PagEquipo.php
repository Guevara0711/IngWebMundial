...
<head>
    ...
    <link href="<?php $root;?>/Design/CSS/PagEquipoStyle.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="contenedor-nombre-favorito">
      <div  class="contenedor-bandera-nombre">
        <div class="imagen">
          <img src="<?php $root;?>/Design/Image\banderaespaña.webp" alt="">
        </div>
      ...
      <div class="contenedor-jugadores-interno">
        <div class="contenedor-porteros">
          ...
          <div class="portero-individual">
            <div class="jugador">
              <img src="<?php $root;?>/Design/Image\usuario.png" alt="">
