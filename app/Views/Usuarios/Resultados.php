...
<head>
    ...
    <link href="/Design/CSS/ResultStyle.css" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <nav>
            <div class="contenedor-menu">
                <div class="contenedor-imagen-mundial">
                    <a href="/index.php"><img src="IMGs\qatar2022.png" alt=""></a>
                </div>
                <ul class="menu">
                    ...
                    <li><a href="/Views/Usuarios/Resultados.php" class="seleccion">Resultados</a></li>
    ...
    <script src="/Design/JS\ResultadoJS.js" charset="utf-8"></script>
    </body>
</html>